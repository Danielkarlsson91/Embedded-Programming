...
public:
    Car(int id, const std::string &model, int maxPassengers) : Vehicle(id, model, "car"), maxPassengers(maxPassengers) {}

    void printProperties() const override
    {
        std::cout << "ID: " << id << ", Model: " << model << ", Type: Car, Max Passengers: " << maxPassengers << std::endl;
    }
};
...
public:
    Truck(int id, const std::string &model, int maxLoadWeight) : Vehicle(id, model, "truck"), maxLoadWeight(maxLoadWeight) {}

    void printProperties() const override
    {
        std::cout << "ID: " << id << ", Model: " << model << ", Type: Truck, Max Load Weight: " << maxLoadWeight << std::endl;
    }
};
